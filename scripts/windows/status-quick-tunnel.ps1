...
Invoke-WslService $Deployment.gateway.distro $GatewayRepoPath "cd '$GatewayRepoPath' && ./scripts/wsl/status-service.sh quick-tunnel && if [ -f data/runtime/quick-tunnel.url ]; then cat data/runtime/quick-tunnel.url; fi"
